...
extern const u32 gBattleAnimSpritePal_flash_cannon_ball[];
extern const u32 gBattleAnimSpriteGfx_flash_cannon_ball[];
extern const u32 gBattleAnimSpritePal_poison_jab[];
extern const u32 gBattleAnimSpriteGfx_poison_jab[];
extern const u32 gBattleAnimSpritePal_power_gem[];
extern const u32 gBattleAnimSpriteGfx_power_gem[];
extern const u32 gBattleAnimSpritePal_shell_right[];
extern const u32 gBattleAnimSpriteGfx_shell_right[];
extern const u32 gBattleAnimSpritePal_shell_left[];
extern const u32 gBattleAnimSpriteGfx_shell_left[];
extern const u32 gBattleAnimSpritePal_razor_shell[];
extern const u32 gBattleAnimSpriteGfx_razor_shell[];
extern const u32 gBattleAnimSpritePal_hydro_pump[];
extern const u32 gBattleAnimSpriteGfx_hydro_pump[];
extern const u32 gBattleAnimSpritePal_water_gun[];
extern const u32 gBattleAnimSpriteGfx_water_gun[];
extern const u32 gBattleAnimSpritePal_brine[];
extern const u32 gBattleAnimSpriteGfx_brine[];
extern const u32 gBattleAnimSpritePal_stealth_rock[];
extern const u32 gBattleAnimSpriteGfx_stealth_rock[];
extern const u32 gBattleAnimSpritePal_stone_edge[];
extern const u32 gBattleAnimSpriteGfx_stone_edge[];
extern const u32 gBattleAnimSpritePal_gear[];
extern const u32 gBattleAnimSpriteGfx_gear[];
extern const u32 gBattleAnimSpritePal_assurance_hand[];
extern const u32 gBattleAnimSpriteGfx_assurance_hand[];
extern const u32 gBattleAnimSpritePal_acupressure_finger[];
extern const u32 gBattleAnimSpriteGfx_acupressure_finger[];
extern const u32 gBattleAnimSpritePal_punishment_blades[];
extern const u32 gBattleAnimSpriteGfx_punishment_blades[];
extern const u32 gBattleAnimSpritePal_bees[];
extern const u32 gBattleAnimSpriteGfx_bees[];
extern const u32 gBattleAnimSpritePal_wishiwashi_fish[];
extern const u32 gBattleAnimSpriteGfx_wishiwashi_fish[];
extern const u32 gBattleAnimSpritePal_zygarde_hexes[];
extern const u32 gBattleAnimSpriteGfx_zygarde_hexes[];
extern const u32 gBattleAnimSpritePal_aura_sphere[];
extern const u32 gBattleAnimSpriteGfx_aura_sphere[];
extern const u32 gBattleAnimSpritePal_energy_ball[];
extern const u32 gBattleAnimSpriteGfx_energy_ball[];
extern const u32 gBattleAnimSpritePal_mega_rainbow[];
extern const u32 gBattleAnimSpriteGfx_mega_rainbow[];
extern const u32 gBattleAnimSpritePal_mega_stone[];
extern const u32 gBattleAnimSpriteGfx_mega_stone[];
extern const u32 gBattleAnimSpritePal_mega_symbol[];
extern const u32 gBattleAnimSpriteGfx_mega_symbol[];
extern const u32 gBattleAnimSpritePal_omega_stone[];
extern const u32 gBattleAnimSpriteGfx_omega_stone[];
extern const u32 gBattleAnimSpritePal_alpha_stone[];
extern const u32 gBattleAnimSpriteGfx_alpha_stone[];
extern const u32 gBattleAnimSpritePal_berry_normal[];
extern const u32 gBattleAnimSpriteGfx_berry_normal[];
extern const u32 gBattleAnimSpritePal_berry_eaten[];
extern const u32 gBattleAnimSpriteGfx_berry_eaten[];
extern const u32 gBattleAnimSpritePal_dragon_ascent[];
extern const u32 gBattleAnimSpriteGfx_dragon_ascent[];
extern const u32 gBattleAnimSpritePal_pink_diamond[];
extern const u32 gBattleAnimSpriteGfx_pink_diamond[];
extern const u32 gBattleAnimSpritePal_steam_eruption[];
extern const u32 gBattleAnimSpriteGfx_steam_eruption[];
extern const u32 gBattleAnimSpritePal_confide[];
extern const u32 gBattleAnimSpriteGfx_confide[];
extern const u32 gBattleAnimSpritePal_vertical_hex[];
extern const u32 gBattleAnimSpriteGfx_vertical_hex[];
extern const u32 gBattleAnimSpritePal_power_trick[];
extern const u32 gBattleAnimSpriteGfx_power_trick[];
extern const u32 gBattleAnimSpritePal_chain_link[];
extern const u32 gBattleAnimSpriteGfx_chain_link[];
extern const u32 gBattleAnimSpritePal_anchor[];
extern const u32 gBattleAnimSpriteGfx_anchor[];
extern const u32 gBattleAnimSpritePal_horseshoe_side_fist[];
extern const u32 gBattleAnimSpriteGfx_horseshoe_side_fist[];
extern const u32 gBattleAnimSpritePal_dragon_ascent_foe[];
extern const u32 gBattleAnimSpriteGfx_dragon_ascent_foe[];
extern const u32 gBattleAnimSpritePal_crafty_shield[];
extern const u32 gBattleAnimSpriteGfx_crafty_shield[];
extern const u32 gBattleAnimSpritePal_quick_guard_hand[];
extern const u32 gBattleAnimSpriteGfx_quick_guard_hand[];
extern const u32 gBattleAnimSpritePal_blacephalon_head[];
extern const u32 gBattleAnimSpriteGfx_blacephalon_head[];
extern const u32 gBattleAnimSpritePal_fairy_lock_chains[];
extern const u32 gBattleAnimSpriteGfx_fairy_lock_chains[];
extern const u32 gBattleAnimSpritePal_ions[];
extern const u32 gBattleAnimSpriteGfx_ions[];
extern const u32 gBattleAnimSpritePal_chop[];
extern const u32 gBattleAnimSpriteGfx_chop[];
extern const u32 gBattleAnimSpritePal_heart_stamp[];
extern const u32 gBattleAnimSpriteGfx_heart_stamp[];
extern const u32 gBattleAnimSpritePal_horn_leech[];
extern const u32 gBattleAnimSpriteGfx_horn_leech[];
extern const u32 gBattleAnimSpritePal_steamroller[];
extern const u32 gBattleAnimSpriteGfx_steamroller[];
extern const u32 gBattleAnimSpritePal_hoopa_hand[];
extern const u32 gBattleAnimSpriteGfx_hoopa_hand[];
extern const u32 gBattleAnimSpritePal_hoopa_ring[];
extern const u32 gBattleAnimSpriteGfx_hoopa_ring[];
extern const u32 gBattleAnimSpritePal_metal_bits[];
extern const u32 gBattleAnimSpriteGfx_metal_bits[];
extern const u32 gBattleAnimSpritePal_small_rock[];
extern const u32 gBattleAnimSpriteGfx_small_rock[];
extern const u32 gBattleAnimSpritePal_spirit_arrow[];
extern const u32 gBattleAnimSpriteGfx_spirit_arrow[];
extern const u32 gBattleAnimSpritePal_ultra_burst_symbol[];
extern const u32 gBattleAnimSpriteGfx_ultra_burst_symbol[];
extern const u32 gBattleAnimSpritePal_z_move_symbol[];
extern const u32 gBattleAnimSpriteGfx_z_move_symbol[];
extern const u32 gBattleAnimSpritePal_really_big_rock[];
extern const u32 gBattleAnimSpriteGfx_really_big_rock[];
extern const u32 gBattleAnimSpritePal_cocoon[];
extern const u32 gBattleAnimSpriteGfx_cocoon[];
extern const u32 gBattleAnimSpritePal_corkscrew[];
extern const u32 gBattleAnimSpriteGfx_corkscrew[];
extern const u32 gBattleAnimSpritePal_havoc_spear[];
extern const u32 gBattleAnimSpriteGfx_havoc_spear[];
extern const u32 gBattleAnimSpritePal_purple_drake[];
extern const u32 gBattleAnimSpriteGfx_purple_drake[];
extern const u32 gBattleAnimSpritePal_ability_pop_up[];
extern const u32 gBattleAnimSpriteGfx_ability_pop_up[];
extern const u32 gBattleAnimSpritePal_mud_bomb[];
extern const u32 gBattleAnimSpriteGfx_mud_bomb[];
...
extern const u32 gBattleAnimSpritePal_poison_column[];
extern const u32 gBattleAnimSpriteGfx_poison_column[];
extern const u32 gBattleAnimSpritePal_poison_column[];
extern const u32 gBattleAnimSpriteGfx_poison_column[];
extern const u32 gBattleAnimSpritePal_large_spike[];
extern const u32 gBattleAnimSpriteGfx_large_spike[];
extern const u32 gBattleAnimSpritePal_dragon_pulse_ring[];
extern const u32 gBattleAnimSpriteGfx_dragon_pulse_ring[];
extern const u32 gBattleAnimSpritePal_stone_pillar[];
extern const u32 gBattleAnimSpriteGfx_stone_pillar[];
extern const u32 gBattleAnimSpritePal_mushroom[];
extern const u32 gBattleAnimSpriteGfx_mushroom[];
extern const u32 gBattleAnimSpritePal_golden_apple[];
extern const u32 gBattleAnimSpriteGfx_golden_apple[];
extern const u32 gBattleAnimSpritePal_ice_rock[];
extern const u32 gBattleAnimSpriteGfx_ice_rock[];
extern const u32 gBattleAnimSpritePal_tornado[];
extern const u32 gBattleAnimSpriteGfx_tornado[];
extern const u32 gBattleAnimSpritePal_straight_beam[];
extern const u32 gBattleAnimSpriteGfx_straight_beam[];
extern const u32 gBattleAnimSpritePal_dreepy[];
extern const u32 gBattleAnimSpriteGfx_dreepy[];
extern const u32 gBattleAnimSpritePal_ice_rock[];
extern const u32 gBattleAnimSpriteGfx_ice_rock[];
extern const u32 gBattleAnimSpritePal_stone_pillar[];
extern const u32 gBattleAnimSpriteGfx_stone_pillar[];
