...
#define ANIM_TAG_WOOD                       (ANIM_SPRITES_START + 289)
#define ANIM_TAG_FLASH_CANNON_BALL          (ANIM_SPRITES_START + 290)
#define ANIM_TAG_POISON_JAB                 (ANIM_SPRITES_START + 291)
#define ANIM_TAG_POWER_GEM                  (ANIM_SPRITES_START + 292)
#define ANIM_TAG_SHELL_RIGHT                (ANIM_SPRITES_START + 293)
#define ANIM_TAG_SHELL_LEFT                 (ANIM_SPRITES_START + 294)
#define ANIM_TAG_RAZOR_SHELL                (ANIM_SPRITES_START + 295)
#define ANIM_TAG_HYDRO_PUMP                 (ANIM_SPRITES_START + 296)
#define ANIM_TAG_WATER_GUN                  (ANIM_SPRITES_START + 297)
#define ANIM_TAG_BRINE                      (ANIM_SPRITES_START + 298)
#define ANIM_TAG_STEALTH_ROCK               (ANIM_SPRITES_START + 299)
#define ANIM_TAG_STONE_EDGE                 (ANIM_SPRITES_START + 300)
#define ANIM_TAG_GEAR                       (ANIM_SPRITES_START + 301)
#define ANIM_TAG_ASSURANCE_HAND             (ANIM_SPRITES_START + 302)
#define ANIM_TAG_ACUPRESSURE_FINGER         (ANIM_SPRITES_START + 303)
#define ANIM_TAG_PUNISHMENT_BLADES          (ANIM_SPRITES_START + 304)
#define ANIM_TAG_BEES                       (ANIM_SPRITES_START + 305)
#define ANIM_TAG_WISHIWASHI_FISH            (ANIM_SPRITES_START + 306)
#define ANIM_TAG_ZYGARDE_HEXES              (ANIM_SPRITES_START + 307)
#define ANIM_TAG_AURA_SPHERE                (ANIM_SPRITES_START + 308)
#define ANIM_TAG_ENERGY_BALL                (ANIM_SPRITES_START + 309)
#define ANIM_TAG_MEGA_RAINBOW               (ANIM_SPRITES_START + 310)
#define ANIM_TAG_MEGA_STONE                 (ANIM_SPRITES_START + 311)
#define ANIM_TAG_MEGA_SYMBOL                (ANIM_SPRITES_START + 312)
#define ANIM_TAG_OMEGA_STONE                (ANIM_SPRITES_START + 313)
#define ANIM_TAG_ALPHA_STONE                (ANIM_SPRITES_START + 314)
#define ANIM_TAG_BERRY_NORMAL               (ANIM_SPRITES_START + 315)
#define ANIM_TAG_BERRY_EATEN                (ANIM_SPRITES_START + 316)
#define ANIM_TAG_DRAGON_ASCENT              (ANIM_SPRITES_START + 317)
#define ANIM_TAG_PINK_DIAMOND               (ANIM_SPRITES_START + 318)
#define ANIM_TAG_STEAM_ERUPTION             (ANIM_SPRITES_START + 319)
#define ANIM_TAG_CONFIDE                    (ANIM_SPRITES_START + 320)
#define ANIM_TAG_VERTICAL_HEX               (ANIM_SPRITES_START + 321)
#define ANIM_TAG_POWER_TRICK                (ANIM_SPRITES_START + 322)
#define ANIM_TAG_CHAIN_LINK                 (ANIM_SPRITES_START + 323)
#define ANIM_TAG_ANCHOR                     (ANIM_SPRITES_START + 324)
#define ANIM_TAG_HORSESHOE_SIDE_FIST        (ANIM_SPRITES_START + 325)
#define ANIM_TAG_DRAGON_ASCENT_FOE          (ANIM_SPRITES_START + 326)
#define ANIM_TAG_CRAFTY_SHIELD              (ANIM_SPRITES_START + 327)
#define ANIM_TAG_QUICK_GUARD_HAND           (ANIM_SPRITES_START + 328)
#define ANIM_TAG_BLACEPHALON_HEAD           (ANIM_SPRITES_START + 329)
#define ANIM_TAG_FAIRY_LOCK_CHAINS          (ANIM_SPRITES_START + 330)
#define ANIM_TAG_IONS                       (ANIM_SPRITES_START + 331)
#define ANIM_TAG_CHOP                       (ANIM_SPRITES_START + 332)
#define ANIM_TAG_HEART_STAMP                (ANIM_SPRITES_START + 333)
#define ANIM_TAG_HORN_LEECH                 (ANIM_SPRITES_START + 334)
#define ANIM_TAG_STEAMROLLER                (ANIM_SPRITES_START + 335)
#define ANIM_TAG_HOOPA_HAND                 (ANIM_SPRITES_START + 336)
#define ANIM_TAG_HOOPA_RING                 (ANIM_SPRITES_START + 337)
#define ANIM_TAG_UNAVAILABLE_1              (ANIM_SPRITES_START + 338)
#define ANIM_TAG_UNAVAILABLE_2              (ANIM_SPRITES_START + 339)
#define ANIM_TAG_METAL_BITS                 (ANIM_SPRITES_START + 340)
#define ANIM_TAG_SMALL_ROCK                 (ANIM_SPRITES_START + 341)
#define ANIM_TAG_SPIRIT_ARROW               (ANIM_SPRITES_START + 342)
#define ANIM_TAG_ULTRA_BURST_SYMBOL         (ANIM_SPRITES_START + 343)
#define ANIM_TAG_Z_MOVE_SYMBOL              (ANIM_SPRITES_START + 344)
#define ANIM_TAG_REALLY_BIG_ROCK            (ANIM_SPRITES_START + 345)
#define ANIM_TAG_COCOON                     (ANIM_SPRITES_START + 346)
#define ANIM_TAG_CORKSCREW                  (ANIM_SPRITES_START + 347)
#define ANIM_TAG_HAVOC_SPEAR                (ANIM_SPRITES_START + 348)
#define ANIM_TAG_PURPLE_DRAKE               (ANIM_SPRITES_START + 349)
#define ANIM_TAG_ABILITY_POP_UP             (ANIM_SPRITES_START + 350)
#define ANIM_TAG_MUD_BOMB                   (ANIM_SPRITES_START + 351)
#define ANIM_TAG_BRANCH                     (ANIM_SPRITES_START + 352)
#define ANIM_TAG_APPLE                      (ANIM_SPRITES_START + 353)
#define ANIM_TAG_OBSTRUCT_CROSS             (ANIM_SPRITES_START + 354)
#define ANIM_TAG_POISON_COLUMN              (ANIM_SPRITES_START + 355)
#define ANIM_TAG_GARBAGE_COLUMN             (ANIM_SPRITES_START + 356)
#define ANIM_TAG_LARGE_SPIKE                (ANIM_SPRITES_START + 357)
#define ANIM_TAG_DRAGON_PULSE_RING          (ANIM_SPRITES_START + 358)
#define ANIM_TAG_STONE_PILLAR               (ANIM_SPRITES_START + 359)
#define ANIM_TAG_MUSHROOM                   (ANIM_SPRITES_START + 360)
#define ANIM_TAG_GOLDEN_APPLE               (ANIM_SPRITES_START + 361)
#define ANIM_TAG_ICE_ROCK                   (ANIM_SPRITES_START + 362)
#define ANIM_TAG_TORNADO                    (ANIM_SPRITES_START + 363)
#define ANIM_TAG_STRAIGHT_BEAM              (ANIM_SPRITES_START + 364)
#define ANIM_TAG_DREEPY                     (ANIM_SPRITES_START + 365)
#define ANIM_TAG_ICE_ROCK_SINGLE            (ANIM_SPRITES_START + 366)
#define ANIM_TAG_STONE_PILLAR_MULTI         (ANIM_SPRITES_START + 367)
...
#define BG_ROCK_WRECKER 0x1B
#define BG_WATER 0x1C
#define BG_NIGHTMARE 0x1D
#define BG_LEAF_STORM 0x1E
#define BG_FIRE 0x1F
#define BG_FIRE_2 0x20
#define BG_GIGA_IMPACT_ON_OPPONENT 0x21
#define BG_GIGA_IMPACT_ON_PLAYER 0x22
#define BG_WATER_2 0x23
#define BG_POISON 0x24
#define BG_AEROBLAST 0x25
#define BG_HIGH_SPEED 0x26
#define BG_ELECTRIC_TERRAIN 0x27
#define BG_GRASSY_TERRAIN 0x28
#define BG_MISTY_TERRAIN 0x29
#define BG_PSYCHIC_TERRAIN 0x2A
#define BG_SPACIAL_REND_ON_OPPONENT 0x2B
#define BG_SPACIAL_REND_ON_PLAYER 0x2C
#define BG_DARK_VOID 0x2D
#define BG_FOCUS_BLAST 0x2E
#define BG_GUNK_SHOT 0x2F
#define BG_HYDRO_CANNON 0x30
#define BG_TRICK_ROOM 0x31
#define BG_WONDER_ROOM 0x32
#define BG_MAGIC_ROOM 0x33
#define BG_HYPERSPACE_FURY 0x34
#define BG_BOLT_STRIKE 0x35
#define BG_ZMOVE_ACTIVATE 0x36
#define BG_TECTONIC_RAGE 0x37
#define BG_BLUE_SKY_DAY 0x38
#define BG_BLUE_SKY_AFTERNOON 0x39
#define BG_BLUE_SKY_NIGHT 0x3A
#define BG_ZMOVE_MOUNTAIN 0x3B
#define BG_NEVERENDING_NIGHTMARE 0x3C
#define BG_WATER_PULSE 0x3D
#define BG_INFERNO_OVERDRIVE 0x3E
#define BG_BLOOM_DOOM 0x3F
#define BG_SHATTERED_PSYCHE 0x40
#define BG_TWINKLE_TACKLE 0x41
#define BG_BLACKHOLE_ECLIPSE 0x42
#define BG_SOULSTEALING_7STAR_STRIKE_STILL_RAW 0x43
#define BG_MALICIOUS_MOONSAULT 0x44
#define BG_CLANGOROUS_SOULBLAZE 0x45
#define BG_SNUGGLE_FOREVER 0x46
#define BG_MAX_LIGHTNING 0x47
#define BG_GARBAGE_FALLS 0x48
#define BG_HYPER_BEAM 0x49
#define BG_DYNAMAX_CANNON 0x4A
#define BG_AURA_SPHERE 0x4B
