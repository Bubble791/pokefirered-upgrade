...
void AnimMegahornHorn(struct Sprite *sprite);
void AnimLeechLifeNeedle(struct Sprite *sprite);
void AnimTranslateWebThread(struct Sprite *sprite);
void AnimStringWrap(struct Sprite *sprite);
void AnimTranslateStinger(struct Sprite *sprite);
void AnimTailGlowOrb(struct Sprite *sprite);
void sub_80B41C0(struct Sprite *sprite);
void sub_80B42E8(struct Sprite *sprite);
void sub_80B4344(struct Sprite *sprite);
...
const union AffineAnimCmd *const sAffineAnims_LeechLifeNeedle[] =
{
...
const union AffineAnimCmd *const sAffineAnims_SpiderWeb[] =
{
